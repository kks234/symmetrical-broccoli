...
@EnableJpaRepositories(
        ...
        basePackages = "com.develop.ADsync.jpa.repo.sqlite."
)
public class SqliteConfig {
    ...
    public LocalContainerEntityManagerFactoryBean sqliteEntityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("com.develop.ADsync.jpa.entity.sqlite.")
                .properties(properties)
                .persistenceUnit("sqliteEntityManager")
                .build();
    }

    @Primary
    @Bean
    public PlatformTransactionManager sqliteTransactionManager(@Qualifier("sqliteEntityManagerFactory") EntityManagerFactory entityManagerFactory) {
